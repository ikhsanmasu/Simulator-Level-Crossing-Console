...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ALARM.setText("")
        self.ALARM.setPixmap(QtGui.QPixmap(dir + "/ICON/Console.jpg"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(dir + "/ICON/selector-switch-AUTOMATIC.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.SELECTOR_SWITCH.clicked.connect(self.ALARMclicked)
